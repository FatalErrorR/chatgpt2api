...
const docs: ApiDoc[] = [
  ...
  },
  {
    ...
    input: [
      ...
      ["model", "string", "可选，默认 gpt-image-2。2.5 可用 gpt-image-2.5 / gpt-image-2.5-flare / gpt-image-2.5-sunburst。"],
...
const usableModels = ["gpt-image-2", "gpt-image-2.5", "gpt-image-2.5-flare", "gpt-image-2.5-sunburst", "codex-gpt-image-2", "codex-gpt-image-2.5", "codex-gpt-image-2.5-flare", "codex-gpt-image-2.5-sunburst", "auto", "gpt-5", "gpt-5-1", "gpt-5-2", "gpt-5-3", "gpt-5-3-mini", "gpt-5-mini"];
